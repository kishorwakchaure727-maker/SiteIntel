...
st.set_page_config(page_title="SiteIntel Health", layout="centered")
st.title("SiteIntel — Health Check")
st.write("OK")

st.caption("This is a temporary health-check page used to verify deployment. `app_full.py` contains the original app.")
